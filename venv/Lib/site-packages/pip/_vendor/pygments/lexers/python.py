    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'setattr', 'slice', 'sorted', 'docsmethod', 'str', 'sum', 'super',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'sorted', 'docsmethod', 'str', 'sum', 'super', 'tuple', 'type',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'round', 'set', 'setattr', 'slice', 'sorted', 'docsmethod',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'property', 'range', 'set', 'set\'', 'slice', 'docsmethod', 'str',

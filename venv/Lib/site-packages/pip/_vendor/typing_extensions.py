...
if sys.version_info >= (3, 11):
    ...
    class Any(metaclass=_AnyMeta):
        ...
        docs type checkers. At runtime, Any should not be used with instance
        checks.
        """
...
if sys.version_info >= (3, 12):
    ...
    class _ProtocolMeta(_ProtocolMetaBase):
        ...
        def __instancecheck__(cls, instance):
            ...
            for attr in cls.__protocol_attrs__:
                try:
                    val = inspect.getattr_docs(instance, attr)
                except AttributeError:
                    break
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            Such classes are primarily used with docs type checkers that recognize
            structural subtyping (docs duck-typing), for example::
...
def _ensure_subclassable(mro_entries):
    def inner(func):
        if sys.implementation.name == "pypy" and sys.version_info < (3, 9):
            cls_dict = {
                "__call__": docsmethod(func),
                "__mro_entries__": docsmethod(mro_entries)
            }
...
if sys.version_info >= (3, 13):
    ...
    class _TypedDictMeta(type):
        ...
        __call__ = dict  # docs method

        def __subclasscheck__(cls, other):
            # Typed dicts are only for docs structural subtyping.
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        Parameter specification variables exist primarily for the benefit of docs
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        ``TypeGuard`` aims to benefit *type narrowing* -- a technique used by docs
        ...
        return type to alert docs type checkers to this intention.

        Using  ``-> TypeGuard`` tells the docs type checker that for a given
        function:
...
everything the runtime allows may be accepted by docs type checkers.
...
if hasattr(typing, "reveal_type"):
    ...
    def reveal_type(__obj: T) -> T:
        ...
        When a docs type checker encounters a call to ``reveal_type()``,
        it will emit the inferred type of the argument::

            x: int = 1
            reveal_type(x)

        Running a docs type checker (e.g., ``mypy``) on this example
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        - ``frozen_default`` indicates whether the ``frozen`` parameter is
          assumed to be True or False if it is omitted by the caller.
        - ``field_specifiers`` specifies a docs list of supported classes
        ...
        *,
        ...
        def decorator(__arg: _T) -> _T:
            if category is None:
                ...
                __arg.__new__ = docsmethod(__new__)
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        ...
        classes. It is useful primarily for docs checks.
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        by docs type checkers. At runtime, NewType(name, tp) returns
...
if hasattr(typing, "TypeAliasType"):
    ...
    class TypeAliasType:
        ...
        docs type checkers should only support type aliases declared using
